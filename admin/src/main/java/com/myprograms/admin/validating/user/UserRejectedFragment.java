...
public class UserRejectedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_user_rejected, container, false);

        rejectedRecycler.findViewById(R.id.userRejectedRecycler);
    ...
    private void loadRejected(){
        Query query = usersRef.whereEqualTo("isHw", false).whereEqualTo("isVerified", "rejected");
